image:https://github.com/st-tu-dresden-praktikum/swt21w19/workflows/CI%20build/badge.svg["CI Build", link="https://github.com/st-tu-dresden-praktikum/swt21w19/actions"]
...
The papapizza module is a template project to bootstrap the Java project in the Software Engineering lab.
