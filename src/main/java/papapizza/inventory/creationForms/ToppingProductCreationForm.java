...
/**
 * Form for frontend to create {@link ToppingProduct}s.
 */
@Getter
@Setter
public class ToppingProductCreationForm {
	...
	public ToppingProductCreationForm(String name, String price){
		this.name = name;
		this.price = price;
	}
	 ...
	 */
	public static void setProductDetails(ToppingProductCreationForm form, ToppingProduct product){
	 ...
	 */
	public static void setFormDetails(ToppingProductCreationForm form, ToppingProduct product){
