...
/**
 * Form for frontend to create {@link OvenProduct}s.
 */
@Getter
@Setter
public class OvenProductCreationForm {
	...
	public OvenProductCreationForm(String name, String price){
		this.name = name;
		this.price = price;
	}
	 ...
	 */
	public static void setProductDetails(OvenProductCreationForm form, OvenProduct product){
	 ...
	 */
	public static void setFormDetails(OvenProductCreationForm form, OvenProduct product){
